...
export class ItemForm {
    private static _defaultForm: ItemForm = null;

    // Closes the item form
    static close() {
        this._defaultForm._useModal ? Modal.hide() : CanvasForm.hide();
    }
    ...
    static edit(props: IItemFormEditProps): PromiseLike<void> {
        ...
        // Set the mode
        this._defaultForm._controlMode = SPTypes.ControlMode.Edit;
    ...
    static setSize(value: number) {
        ...
        this._defaultForm._useModal ? Modal.setType(value) : CanvasForm.setSize(value);
    }
    ...
    static view(props: IItemFormViewProps): PromiseLike<void> {
        ...
        // Set the mode
        this._defaultForm._controlMode = SPTypes.ControlMode.Display;
    ...
    private _elForm: HTMLElement = null;
    ...
    private _onFormRendered?: (form?: Components.IListFormDisplay | Components.IListFormEdit) => void = null;
    ...
    private _onShowForm?: (form?: CanvasForm | Modal) => void = null;
    private _onSave: (values: any) => any | PromiseLike<any> = null;
    private _onSaveError: (err: any) => void = null;
    private _onValidation: (values?: any, isValid?: boolean) => boolean | PromiseLike<boolean> = null;
    private _requestDigest: string = null;
    private _tabInfo: IItemFormTabInfo = null;
    ...
    // Display Form
    private _displayForms: Components.IListFormDisplay[] = null;
    get DisplayForm(): Components.IListFormDisplay { return this._displayForms[0]; }
    get DisplayForms(): Components.IListFormDisplay[] { return this._displayForms; }

    // Edit Form
    private _editForms: Components.IListFormEdit[] = null;
    get EditForm(): Components.IListFormEdit { return this._editForms[0]; }
    get EditForms(): Components.IListFormEdit[] { return this._editForms; }

    // Form Information
    private _info: Helper.IListFormResult = null;
    ...
    // List Form Tabs
    private _tabs: Components.IListGroup = null;
    get Tabs(): Components.IListGroup { return this._tabs; }
    ...
    renderFooter(elForm: HTMLElement) {
    ...
    private load(webUrl?: string, itemId?: number): PromiseLike<void> {
        // Clear the forms
        this._displayForms = [];
        this._editForms = [];
    ...
    private renderDisplayForm(el?: HTMLElement, tab?: IItemFormTab) {
    ...
    private renderEditForm(el?: HTMLElement, tab?: IItemFormTab) {
        // Ensure the element exists
        el = el || document.createElement("div");
    ...
    // Renders the footer
    private renderFormFooter(elFooter?: HTMLElement) {
    ...
    // Validates the form
    private validate(values: any, isValid: boolean): PromiseLike<boolean> {
        // Return a promise
        return new Promise((resolve, reject) => {
